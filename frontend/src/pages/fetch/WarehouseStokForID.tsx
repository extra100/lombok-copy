...
export const useFetchWarehouseIDToGetEachWarehouseWty = () => {
  const [loading, setLoading] = useState(true)
  const [warehouseID, setWarehouseID] = useState<Invoice[]>([])
    ...
    const fetchData = async () => {
      try {
        ...
        const invoicesResponse = await fetch(
          `${HOST}/finance/warehouses?page=1&per_page=100`,
          {
            headers: {
