...
interface TogglePelangganProps {
  showIdH: boolean
  showA: boolean
  toggleshowIdH: () => void
  toggleshowA: () => void
...
const TogglePelanggan: React.FC<TogglePelangganProps> = ({
  showIdH,
  showA,
  toggleshowIdH,
  toggleshowA,
  ...
  const menuItems = [
    {
      label: (
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <span>{showIdH ? 'Hide Id Pelanggan' : 'Show Id Pelanggan'}</span>
        </div>
      ),
      key: '1',
    },
...
export default TogglePelanggan
