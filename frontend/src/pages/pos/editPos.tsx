...
const EditPos: React.FC = () => {
  ...
  const handleSave = () => {
    poss.forEach((pos) => {
      ...
      console.log('Data yang akan disimpan:', posFormData)
        ...
        >
          ...
          >
                ...
                >
                  {pelanggans
                    ? pelanggans
                        .filter(
                          (pelanggan) =>
                            pelanggan.type_kontak.includes('Pelanggan') &&
                            pelanggan.id_outlet !== user?.id_outlet
                        )
                        .map((pelanggan) => (
                          <Select.Option
            ...
            >
              ...
              <Input value={currentIdPos} style={{ width: '100%' }} disabled />
            </div>
          </div>
