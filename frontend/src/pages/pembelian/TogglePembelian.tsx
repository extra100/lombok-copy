...
interface TogglePembelianProps {
  showIdH: boolean
  showA: boolean
  toggleshowIdH: () => void
  toggleshowA: () => void
...
const TogglePembelian: React.FC<TogglePembelianProps> = ({
  showIdH,
  showA,
  toggleshowIdH,
  toggleshowA,
  ...
  const menuItems = [
    {
      label: (
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <span>{showIdH ? 'Hide Id Pembelian' : 'Show Id Pembelian'}</span>
        </div>
      ),
      key: '1',
    },
...
export default TogglePembelian
